...
export const useChangeElements = () => {
    ...
    const options = ['Segura?', 'Segurisima?', 'Estas completamente segura?', 'No te arrepentiras?', 'Pero si estas segura?', 'No hay vuelta atras!', 'No hay devoluciones!', 'No hay garantias!', 'No hay reembolsos!', 'No hay cambios!', 'No hay nada!', 'No hay!', 'Que no hay!','Yo no se']
    ...
    const handleButtonYes = () => {
        ...
        setTextP('Gracias por aceptar, te quiero mucho mi niña dinda <3')
        confetti()
    }
